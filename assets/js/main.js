...
$.getJSON(
    "https://uoiwpt8d40.execute-api.eu-west-1.amazonaws.com/stats?name=earth",
    function (records) {
        var burned = +records.burned;
        var hodlers = +records.total_holders;
        var liquid = +records.liquidity;
        var marketcap = +records.market_cap;
        ...
        $(".burned").append(formatter.format(+burned / 1_000_000_000_000) + " T");
        $(".hodlers").append(formatter.format(hodlers));
        $(".liquid").append(formatter.format(liquid));
        $(".marketcap").append(formatter.format(marketcap));
